...
[Spacemesh Setup 0.1.17.exe](https://storage.googleapis.com/smapp/v0.1.17/Spacemesh%20Setup%200.1.17.exe)

### OS X

[Spacemesh-0.1.17.dmg](https://storage.googleapis.com/smapp/v0.1.17/Spacemesh-0.1.17.dmg)

### Linux

?> Debian 8 or newer, Ubuntu 18.04, Fedora 21 or newer, or any other flavor of Linux which supports Electron apps.

[spacemesh_app_0.1.17_amd64.deb](https://storage.googleapis.com/smapp/v0.1.17/ubuntu18_04/spacemesh_app_0.1.17_amd64.deb)

?> Ubuntu 20.04

[spacemesh_app_0.1.17_amd64.deb](https://storage.googleapis.com/smapp/v0.1.17/ubuntu20_04/spacemesh_app_0.1.17_amd64.deb)
